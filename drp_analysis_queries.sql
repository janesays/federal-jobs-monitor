-- ============================================================
-- drp_analysis_queries.sql
-- Queries against monitor.db (postings + historic) to test the
-- three claims in the OPM director's public response
-- to the Partnership backfill analysis, using OPM's own USAJOBS distribution data.
--
-- Usage:  sqlite3 monitor.db < drp_analysis_queries.sql
...
-- activity their 20,557 cannot contain — and that the "85%
...
-- replacements arriving ~1.4 GS grades lower; OPM didn't
